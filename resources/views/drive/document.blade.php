            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"><i class="mdi mdi-file-document-box-outline" style="margin: 0 10px 0 3px;"></i>Documents <small>({{$count_document}})</small></h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 

                        <div class="row default-files-document">
                            @foreach($data as $d)
                        ...
                        <div class="row search-files-document" style="display: none">
