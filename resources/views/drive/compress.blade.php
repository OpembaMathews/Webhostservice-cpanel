            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title"><i class="mdi mdi-folder-zip" style="margin: 0 10px 0 3px;"></i>Compressed <small>({{$count_compress}})</small></h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 

                        <div class="row default-files-compress">
                            @foreach($data as $d)
                        ...
                        <div class="row search-files-compress" style="display: none">
